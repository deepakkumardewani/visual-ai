...
<template>
  <div class="page">
    <!-- <div class="header">
      <div class="container">
        <p class="title">Privacy Policy for Visual AI</p>
      </div>
    </div> -->
    <!-- todo: clean up and remove unnecessary content -->
      ...
      <div class="container">
        <div class="tab-content translations-content-item en visible" id="en">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Visual AI, accessible from
                <a href="https://visual-ai.app" rel="external nofollow noopener" target="_blank"
          ...
          <p>
            ...
            Third-Party Social Media Service's account, such as Your name and Your email address.
          </p>
          <p>
          ...
          <ul>
            <li>
              <p>
                By email:
                <a
                  href="mailto:visual.ai.app@gmail.com"
                  rel="external nofollow noopener"
                  data-cfemail="d9afb0aaacb8b5f7b8b0f7b8a9a999beb4b8b0b5f7bab6b4"
