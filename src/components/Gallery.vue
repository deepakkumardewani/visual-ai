...
const examples = [
  ...
  },
  {
    ...
    url: '/examples/example-2.jpg'
  },
  {
    prompt: 'a tiny astronaut hatching from an egg on the moon',
    url: '/examples/example-3.jpg'
  },
  {
    prompt: 'Baby hedgehog wearing a flower crown in a garden',
    url: '/examples/example-4.jpg'
  },
  {
    prompt:
