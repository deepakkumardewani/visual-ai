...
<template>
  <button
    ...
    class="tw-relative tw-py-1 tw-px-3 tw-mx-3 tw-rounded-lg tw-font-medium tw-text-sm tw-text-slate-100 tw-bg-gradient-to-b tw-from-[#2A2119] tw-to-[#C9A84C] tw-shadow-[0px_0px_12px_#C9A84C]"
  >
