...
- make sure to follow the below guidelines for any code generated

| Task                     | Reference                                            |
| ------------------------ | ---------------------------------------------------- |
| Vue best practices       | `~/.claude/skills/vue-best-practices/SKILL.md`       |
| vue-pinia-best-practices | `~/.claude/skills/vue-pinia-best-practices/SKILL.md` |
